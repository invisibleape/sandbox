...
-- Insert initial data with proper UUID casting
INSERT INTO wallets (id, address, private_key, mnemonic, status, network, chain_id, tag, created_at)
VALUES (
    ...
    1,
    'test wallet',
    '2025-01-31 00:00:00+00'::timestamptz
);

INSERT INTO api_keys (id, provider, key, created_at, updated_at, is_active)
VALUES (
...
INSERT INTO wallet_logs (id, wallet_id, type, message, details, created_at)
VALUES (
    '323e4567-e89b-12d3-a456-426614174000'::uuid,
    '123e4567-e89b-12d3-a456-426614174000'::uuid,
    'info',
    'Wallet created',
    '{"network": "ethereum"}'::jsonb,
    '2025-01-31 00:00:00+00'::timestamptz
);
